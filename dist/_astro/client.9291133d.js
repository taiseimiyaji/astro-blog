...
function Ni(e, n, t, r, l) {
	...
	if ((Gn(n, l), n.stateNode === null))
		xr(e, n), na(n, t, r), ku(n, t, r, l), (r = !0);
	else if (e === null) {
		var o = n.stateNode,
			i = n.memoizedProps;
		o.props = i;
...
function Ia(e) {
	...
	n !== null && ((e.alternate = null), Ia(n)),
		...
		e.tag === 5 &&
			((n = e.stateNode),
			n !== null &&
				(delete n[Ie], delete n[Vt], delete n[mu], delete n[Uf], delete n[$f])),
		(e.stateNode = null),
		(e.return = null),
		(e.dependencies = null),
	...
	switch (e.tag) {
		case 3:
			...
			if (n.current.memoizedState.isDehydrated) {
				...
				t !== 0 &&
					(Xu(n, t | 1), de(n, W()), !(R & 6) && ((rt = W() + 500), mn()));
			}
			break;
		case 13:
			Tn(function () {
...
const Ed =
	...
	(n, t, { default: r, ...l }, { client: u }) => {
		...
		for (const [s, c] of Object.entries(l))
			t[s] = wn.createElement(Iu, { value: c, name: s });
		const o = wn.createElement(
				n,
				t,
				r != null ? wn.createElement(Iu, { value: r }) : r,
			),
			i = Sd(e);
		return (
			i && delete e[i],
